...
def calcular_ano_ultrapassagem_populacional(
    ...
    porcentagem_populacao_menor = taxa_crescimento_populacao_menor*100
    porcentagem_populacao_maior = taxa_crescimento_populacao_maior*100
    anos = 0
    while populacao_menor < populacao_maior:
        if taxa_crescimento_populacao_menor > taxa_crescimento_populacao_maior:
            ...
            return 'A taxa de crescimento do país B (%.1f%%) deve ser menor do que a do país A (%.1f%%)'%(porcentagem_populacao_maior,porcentagem_populacao_menor)
    
    return 'População de A, depois de %i ano(s) será de %i pessoas, superando a de B, que será de %i pessoas'%(anos,populacao_menor,populacao_maior)
